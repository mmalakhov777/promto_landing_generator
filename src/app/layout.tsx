...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://promto.ai/og-image.png', width: 1200, height: 630, alt: 'Промто — создание сайтов, сервисов и ботов с помощью ИИ' }],
  },
  twitter: {
    ...
    description:
      'Начните с простого лендинга и масштабируйте до полноценного продукта. Промто создаёт структуру, дизайн, тексты и код — вам остаётся только описать идею.',
    images: ['https://promto.ai/og-image.png'],
  },
  icons: {
    icon: [
